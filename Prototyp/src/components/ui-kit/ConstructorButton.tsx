...
export const ActionButton: React.FC<{
  children: React.ReactNode;
  action: 'add' | 'edit' | 'delete' | 'save' | 'cancel' | 'secondary' | 'ghost' | 'view' | 'settings';
  size?: 'sm' | 'md' | 'lg';
  className?: string;
  onClick?: () => void;
  disabled?: boolean;
  ...
  const actionConfig = {
    ...
    secondary: { variant: 'secondary' as const, icon: '📋' },
    ghost: { variant: 'ghost' as const, icon: '👻' },
    view: { variant: 'primary' as const, icon: '👁️' },
    settings: { variant: 'primary' as const, icon: '⚙️' }
  };
