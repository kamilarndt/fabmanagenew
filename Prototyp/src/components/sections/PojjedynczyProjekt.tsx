  ...
  return (
    <ConstructorContainer size="xl" padding="lg" className="w-full">
      <ConstructorSection
        ...
        subtitle="Zarządzanie i monitoring projektu"
        spacing="lg"
      >
        {/* Header */}
        <ConstructorFlex direction="row" justify="start" align="center" gap="md">
          <ActionButton action="ghost" size="md" onClick={onBack}>
            Powrót do projektów
          </ActionButton>
        </ConstructorFlex>
        ...
        <DashboardCard
          title={project.name}
          subtitle={`Klient: ${project.client} • Status: ${project.status}`}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="podsumowanie" className="space-y-4 sm:space-y-6">
            ...
            <ConstructorGrid cols={4} gap="lg">
              ...
              <DashboardCard
                ...
                subtitle={`Budżet: ${project.budget}`}
              ...
              <DashboardCard
                ...
                subtitle={`${teamMembers.length} członków`}
              ...
              <DashboardCard
                title="Kluczowe Pliki"
                subtitle={`${keyFiles.length} plików`}
              ...
              >
                {keyFiles.map((file, index) => (
                  <div key={index} className="flex items-center justify-between p-2 bg-muted/50 rounded-lg">
                    ...
                    <ActionButton action="ghost" size="sm" className="flex-shrink-0">
                      Pobierz
                    </ActionButton>
                  </div>
                ))}
            ...
            <DashboardCard
              title="Opis projektu"
              subtitle="Szczegóły i cele projektu"
          ...
          <TabsContent value="kafelki" className="space-y-4 sm:space-y-6">
            ...
            <ConstructorFlex direction="row" justify="between" align="center" gap="md">
              <ConstructorFlex direction="row" gap="md">
                <ActionButton action="add" size="md" onClick={handleAddTile}>
                  Dodaj Kafelek
                </ActionButton>
          ...
          <TabsContent value="pliki">
            <DashboardCard
              ...
              subtitle="Dokumentacja i zasoby"
              icon={<FileText className="w-5 h-5" />}
            >
          ...
          <TabsContent value="wycena">
            <DashboardCard
              title="Wycena i Finanse"
              subtitle="Analiza finansowa projektu"
          ...
          <TabsContent value="zespol">
            <DashboardCard
              ...
              subtitle="Koordynacja i przypisania"
          ...
          <TabsContent value="logistyka">
            <DashboardCard
              title="Logistyka"
              subtitle="Zarządzanie dostawami"
              icon={<Package className="w-5 h-5" />}
            >
              <p className="text-muted-foreground">
