...
class AdvancedFigmaGenerator {
    ...
    classifyComponent(element, children) {
        // Count all children recursively (including those without IDs)
    ...
    async createAtomComponents() {
        ...
        this.createAdditionalAtomComponents();
    ...
    // Create additional individual atom components
    createAdditionalAtomComponents() {
        console.log('⚛️ Creating additional atom components...');
