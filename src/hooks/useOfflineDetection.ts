...
export function useOfflineDetection() {
    ...
    useEffect(() => {
        ...
        const handleOffline = () => {
            ...
            message.warning({
                content: 'Brak połączenia internetowego. Aplikacja działa w trybie offline.',
...
export function withOfflineDetection<P extends object>(Component: React.ComponentType<P>) {
