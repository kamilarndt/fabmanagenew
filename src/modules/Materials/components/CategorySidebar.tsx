...
import { Badge, Card, Input, Space, Tree } from "antd";
...
export default function CategorySidebar({
  ...
  const categoryTreeData = useMemo(() => {
    ...
    const treeData: CategoryNode[] = Object.entries(rhinoCategories)
      .map(([mainKey, mainCategory]) => {
        const mainCount = categoryCounts.get(mainKey) || 0;

        const children: CategoryNode[] = Object.entries(
        ...
        >
          ...
          <div style={{ marginTop: 4 }}>
            {selectedCategories.map((cat) => {
              ...
              const mainName =
                rhinoCategories[main as keyof typeof rhinoCategories]?.name ||
                main;
              const subName = sub || "";
