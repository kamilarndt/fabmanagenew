...
export const FilterPanelV3: React.FC<FilterPanelV3Props> = ({
  ...
  const activeFiltersCount = React.useMemo(() => {
    ...
    filters.status,
    filters.unit,
    filters.thicknessMin,
    filters.thicknessMax,
    filters.priceMin,
    filters.priceMax,
  ]);
  ...
  return (
    <div
      className={className}
      style={{ height: "100%", backgroundColor: "var(--bg-primary)" }}
    >
      {/* Nagłówek */}
      <div
        style={{
      ...
      >
        ...
        >
              ...
              {stockStatuses.map((status) => (
                <Button
                  ...
                  style={{
                    ...
                    color:
                      filters.status === status.value ? "#fff" : status.color,
                  }}
                >
                  <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <Panel
            ...
            key="params"
            extra={
              (filters.thicknessMin != null ||
                filters.thicknessMax != null ||
            ...
            <Row gutter={8} style={{ marginBottom: 8 }}>
              <Col span={12}>
                <Select
                  ...
                  showSearch
                >
                  {[0, 3, 6, 8, 10, 12, 15, 16, 18, 22, 25, 30, 36, 40, 50].map(
                    (v) => (
                      <Select.Option key={`tmin-${v}`} value={v}>
                        {v}
                      </Select.Option>
                    )
                  )}
              ...
              <Col span={12}>
                ...
                >
                  {[
                    3, 6, 8, 10, 12, 15, 16, 18, 22, 25, 30, 36, 40, 50, 80,
                  ].map((v) => (
                    <Select.Option key={`tmax-${v}`} value={v}>
                      {v}
                    </Select.Option>
                  ))}
                </Select>
              ...
              <Col span={12}>
                ...
                >
                  {[0, 10, 20, 50, 100, 200, 500].map((v) => (
                    <Select.Option key={`pmin-${v}`} value={v}>
                      {v}
                    </Select.Option>
                  ))}
                </Select>
              ...
              <Col span={12}>
                ...
                >
                  {[10, 20, 50, 100, 200, 500, 1000].map((v) => (
                    <Select.Option key={`pmax-${v}`} value={v}>
                      {v}
                    </Select.Option>
                  ))}
                </Select>
            ...
            <div>
              ...
              <Space size={[4, 4]} wrap>
                ...
                {filters.status && (
                  ...
                  >
                    {
                      stockStatuses.find((s) => s.value === filters.status)
                        ?.label
                    }
                  </Tag>
                )}
                ...
                {(filters.thicknessMin != null ||
                  ...
                  <Tag
                    ...
                    style={{ fontSize: "11px" }}
                  >
                    Grubość: {filters.thicknessMin ?? "—"}–
                    {filters.thicknessMax ?? "—"} mm
                  </Tag>
                )}
                {(filters.priceMin != null || filters.priceMax != null) && (
                  <Tag
                    ...
                    style={{ fontSize: "11px" }}
                  >
                    Cena: {filters.priceMin ?? "—"}–{filters.priceMax ?? "—"}{" "}
                    PLN
                  </Tag>
                )}
              </Space>
