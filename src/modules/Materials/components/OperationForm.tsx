...
export default function OperationForm({
  ...
  const adjustMaterialStock = useMaterialsStore(
    (state) => state.adjustMaterialStock
  );
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      const docType =
        type === "receive" ? "PZ" : type === "issue" ? "WZ" : "KOR";
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    operationItems.forEach((item) => {
      const delta =
        type === "receive" ? item.quantityDelivered : -item.quantityDelivered;
  ...
  const getFormTitle = () => {
    switch (type) {
      case "receive":
        return "Przyjęcie towaru (PZ)";
      case "issue":
        return "Wydanie towaru (WZ)";
      case "transfer":
        return "Przeniesienie magazynowe";
      case "adjust":
        return "Korekta stanu";
      default:
        return "Operacja magazynowa";
    }
  };
                ...
                <div className="card-body">
                  ...
                  {operationItems.length > 0 ? (
                      ...
                      <table className="table table-sm align-middle">
                        <thead>
                          <tr>
                            ...
                            <th>
                              {type === "receive" ? "Dostarczone" : "Wydawane"}
                            </th>
                            <th>Jednostka</th>
                            <th>Lokalizacja</th>
                            <th>Status</th>
                    ...
                    <div className="text-center text-muted py-4">
                      ...
                      <p>
                        Brak pozycji do{" "}
                        {type === "receive" ? "przyjęcia" : "wydania"}
                      </p>
                      <p className="small">
                        Dodaj materiały używając formularza powyżej
                      </p>
                    </div>
                  )}
                </div>
