...
export default function EstimateModule({ projectId }: EstimateModuleProps) {
  ...
  const detailedCostTree = useMemo(() => {
    ...
    modules.forEach((module) => {
      const moduleTiles = projectTiles.filter(
        (tile) =>
          module === "general" ||
      ...
      const moduleNode: CostNode = {
        title: `${
          module === "general" ? "Elementy ogólne" : module.replace("_", " ")
        } (${moduleTiles.length} elementów)`,
        key: `module-${module}`,
        type: "module",
      ...
      const moduleTotal =
        moduleNode.children?.reduce((sum, tile) => sum + (tile.cost || 0), 0) ||
        0;
  ...
  const handleSendToClient = () => {
    ...
    console.warn("TODO: Sending to client...", {
      calculations,
      additionalCosts,
    });
  };
              ...
              <div>
                ...
                <Space direction="vertical" style={{ width: "100%" }}>
                  ...
                  >
                    <Text>Materiały:</Text>
                    <Text strong>
                      {projectCosts.materials.total.toLocaleString("pl-PL")} PLN
                    </Text>
                  </div>
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    <Text>Robocizna:</Text>
                    <Text strong>
                      {projectCosts.labor.total.toLocaleString("pl-PL")} PLN
                    </Text>
                  </div>
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    <Text>Logistyka:</Text>
                    <Text strong>
                      {projectCosts.logistics.total.toLocaleString("pl-PL")} PLN
                    </Text>
                  </div>
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    ...
                    <Text strong>
                      {projectCosts.accommodation.total.toLocaleString("pl-PL")}{" "}
                      PLN
                    </Text>
                  </div>
                </Space>
              ...
              <div>
                ...
                <Space direction="vertical" style={{ width: "100%" }}>
                  ...
                  >
                    ...
                    <Text>
                      {calculations.subtotal.toLocaleString("pl-PL")} PLN
                    </Text>
                  </div>
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    ...
                    <Text style={{ color: "#52c41a" }}>
                      +{calculations.margin.toLocaleString("pl-PL")} PLN
                    </Text>
                  </div>
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    ...
                    <Text style={{ color: "#f5222d" }}>
                      -{calculations.discount.toLocaleString("pl-PL")} PLN
                    </Text>
                  </div>
