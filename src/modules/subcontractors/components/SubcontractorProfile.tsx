        ...
        <Row gutter={24} align="middle">
          ...
          <Col xs={24} sm={12}>
            ...
            <Space>
              ...
              <Button icon={<EditOutlined />}>Edytuj Profil</Button>
            </Space>
          </Col>
          <Col xs={24} sm={6}>
            <div style={{ textAlign: "right" }}>
              ...
              <div>
                ...
                <div style={{ marginTop: 8 }}>
                  <EnvironmentOutlined /> {subcontractor.address}
                  <br />
      ...
      <Row gutter={16}>
            ...
            {subcontractor.notes.length > 0 ? (
              <Timeline>
                {subcontractor.notes.map((note) => (
                  <Timeline.Item key={note}>{note}</Timeline.Item>
                ))}
              </Timeline>
            ) : (
        ...
        <Col xs={24} lg={8}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              >
                ...
                <Text strong style={{ color: "#1890ff" }}>
                  {subcontractor.currentOrders.length}
                </Text>
              </div>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <div>
                <Text strong style={{ fontSize: 16 }}>
                  {subcontractor.pricing.minOrder}{" "}
                  {subcontractor.pricing.currency}
                </Text>
              </div>
            </div>
            <div style={{ marginBottom: 12 }}>
              ...
              <div>
                <Text strong style={{ fontSize: 16 }}>
                  {subcontractor.pricing.averageCost}{" "}
                  {subcontractor.pricing.currency}
                </Text>
              </div>
            </div>
          ...
          <Card title="Pojemność">
            ...
            <Progress
              percent={Math.round(
                (subcontractor.capacity.currentOrders /
                  subcontractor.capacity.maxOrders) *
                  100
              )}
              status={
                subcontractor.capacity.currentOrders >=
