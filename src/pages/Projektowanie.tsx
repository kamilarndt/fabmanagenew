      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex gap-2 align-items-center">
          ...
          <span className="badge bg-primary fs-6">
            {filteredDesignTiles.length} zadań
          </span>
        </div>
      </div>
                ...
                <div className="card h-100">
                  ...
                  <ColumnDrop onDrop={(id) => moveTile(id, col.key)}>
                    {Object.entries(byColumnGrouped[col.key] || {}).length ===
                      0 && <p className="text-muted">Brak zadań</p>}
        ...
        <div className="col-12 col-xl-3">
          <div className="card">
            ...
            <div className="card-body">
              {!selected && (
                <div className="text-muted">Wybierz kafelek po lewej</div>
              )}
              {selected && (
                <div>
  ...
  return (
    ...
    >
      <div className="card-body py-2">
        ...
        <div className="d-flex justify-content-between mt-1 align-items-center"></div>
...
function ColumnDrop({
  ...
  return (
    <div ref={refCb} className="card-body">
      {children}
    </div>
  );
}
