        ...
        <Space>
          ...
          {record.status === "draft" && (
            <Tooltip title="Publish">
              <Button type="text" onClick={() => handlePublish(record)}>
                Publish
              </Button>
            </Tooltip>
          )}
          {record.status === "published" && (
            <Tooltip title="Archive">
              <Button type="text" onClick={() => handleArchive(record)}>
                Archive
              </Button>
            </Tooltip>
          )}
          <Tooltip title="Delete">
            <Button
              ...
              icon={<DeleteOutlined />}
              danger
              onClick={() => handleDelete(record, deleteDocument)}
            />
          </Tooltip>
        </Space>
      ),
      ...
      render: (_: any, record: DocumentCategory) => (
        <Space>
          ...
          <Button
            ...
            icon={<DeleteOutlined />}
            danger
            onClick={() => handleDelete(record, deleteCategory)}
          />
        </Space>
      ),
    },
      ...
      render: (_: any, record: DocumentTemplate) => (
        <Space>
          ...
          <Button
            ...
            icon={<DeleteOutlined />}
            danger
            onClick={() => handleDelete(record, deleteTemplate)}
          />
        </Space>
      ),
    },
          ...
          <div className="space-y-6">
            <Card title="Document Information">
              <Row gutter={16}>
                ...
                <Col span={12}>
                  <p>
                    <strong>Views:</strong> {selectedDocument.view_count}
                  </p>
                  <p>
