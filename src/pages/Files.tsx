...
import { FileItem, FileShare, FileVersion } from "../types/files.types";
        ...
        <Space>
          ...
          <Tooltip title="Delete">
            <Button
              ...
              icon={<DeleteOutlined />}
              danger
              onClick={() => handleDelete(record, deleteFile)}
            />
          </Tooltip>
        </Space>
      ),
  ...
  const folderColumns = [
    ...
    },
    {
      ...
      render: (_: any, record: Folder) => (
        <Space>
          <Button type="text" onClick={() => setCurrentFolder(record.id)}>
            Open
          </Button>
          <Button
            type="text"
          ...
          <Button
            ...
            icon={<DeleteOutlined />}
            danger
            onClick={() => handleDelete(record, deleteFolder)}
          />
        </Space>
      ),
    },
  ...
  const versionColumns = [
    ...
    },
    {
      ...
      render: (_: any, record: FileVersion) => (
        <Space>
          <Button type="text" onClick={() => handleVersionRestore(record)}>
            Restore
          </Button>
          <Button
            type="text"
            icon={<DeleteOutlined />}
            danger
            onClick={() => handleDelete(record, deleteVersion)}
          />
        </Space>
      ),
    },
      ...
      render: (_: any, record: FileShare) => (
        <Space>
          ...
          <Button
            ...
            icon={<DeleteOutlined />}
            danger
            onClick={() => handleDelete(record, unshareFile)}
          />
        </Space>
      ),
    },
