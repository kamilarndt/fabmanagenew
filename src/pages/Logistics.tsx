      ...
      render: (_: any, record: TransportRoute) => (
        <Space>
          ...
          <Button
            type="text"
            danger
            onClick={() => handleDelete(record, deleteRoute)}
          >
            Delete
          </Button>
        </Space>
      ...
      render: (_: any, record: Vehicle) => (
        <Space>
          ...
          <Button
            type="text"
            danger
            onClick={() => handleDelete(record, deleteVehicle)}
          >
            Delete
          </Button>
        </Space>
      ...
      render: (_: any, record: Driver) => (
        <Space>
          ...
          <Button
            type="text"
            danger
            onClick={() => handleDelete(record, deleteDriver)}
          >
            Delete
          </Button>
        </Space>
      ...
      render: (_: any, record: TransportJob) => (
        <Space>
          ...
          <Button
            type="text"
            danger
            onClick={() => handleDelete(record, deleteJob)}
          >
            Delete
          </Button>
        </Space>
