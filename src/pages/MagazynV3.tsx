...
export default function MagazynV3() {
  ...
  const handleFiltersChange = useCallback(
    (newFilters: Partial<MaterialsFilters>) => {
      setFilters((prev) => ({
        ...prev,
        ...newFilters,
  ...
  const handleQuickOrder = useCallback((material: any) => {
    showToast(
      `Szybkie zamówienie dla ${material.name} zostało utworzone`,
      "success"
    );
  }, []);
        ...
        render: (material) => {
          ...
          const color =
            ratio < 0.5
              ...
              : ratio < 1
              ? "#faad14"
              : material.quantity > (material.max_quantity || Infinity)
              ? "#1677ff"
              : "#52c41a";
        ...
        render: (material) => (
          <div>
            <div style={{ fontWeight: 600 }}>
              {(material.unitCost || 0).toFixed(2)} PLN
            </div>
