    ...
    <div>
      ...
      <Toolbar
        left={
          <Space>
            <Tag>
              <i className="ri-time-line" style={{ marginRight: 6 }}></i>Zmiana:
              03:12
            </Tag>
          </Space>
        }
        right={
          <Space>
            <Button
              size="small"
              danger
              onClick={() => alert("Alarmy potwierdzone")}
              title="Potwierdź alarmy"
            >
              <i
        ...
        <Space wrap>
          {machines.map((m) => (
            <Button
              ...
              title={`${m.status} • Część: ${m.part} • ETA ${m.eta}`}
            >
              <Tag
                color={
                  m.status === "Praca"
      ...
      <Row gutter={[12, 12]} style={{ marginBottom: 12 }}>
        <Col xs={12} lg={6}>
          <Card>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 20 }}>{kpis.inQueue}</div>
              <Typography.Text type="secondary">W kolejce</Typography.Text>
            </div>
          </Card>
        </Col>
        <Col xs={12} lg={6}>
          <Card>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 20 }}>{kpis.inCut}</div>
        ...
        <Col xs={12} lg={6}>
          <Card>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 20 }}>{kpis.done}</div>
              <Typography.Text type="secondary">Wycięte</Typography.Text>
            </div>
          </Card>
        </Col>
        <Col xs={12} lg={6}>
          <Card>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 20 }}>{kpis.completion}%</div>
              <Typography.Text type="secondary">Ukończenie</Typography.Text>
            </div>
          </Card>
        </Col>
      </Row>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button size="small" onClick={onEdit} title="Edytuj">
