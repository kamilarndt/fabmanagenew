import type { AtomicComponent} from '../types/atomic-design';
import { ComponentProperties, ComponentVariant } from '../types/atomic-design'

// Component Analyzer - analyzes React components and extracts atomic design structure
export class ComponentAnalyzer {

    // Analyze ProjectCard component
    static analyzeProjectCard(): AtomicComponent[] {
        ...
        components.push({
            ...
            properties: {
                ...
                fontFamily: 'Inter',
                textAlign: 'LEFT',
                lineHeight: { unit: 'AUTO' as const, value: 0 }
            },
            variants: [
    ...
    static analyzeProjectElements(): AtomicComponent[] {
        const components: AtomicComponent[] = []
    ...
    // Get all components
    static getAllComponents(): AtomicComponent[] {
        return [
    ...
    static getComponentsByType(type: 'atom' | 'molecule' | 'organism'): AtomicComponent[] {
        return this.getAllComponents().filter(component => component.type === type)
    }

    // Get components by category
    static getComponentsByCategory(category: string): AtomicComponent[] {
