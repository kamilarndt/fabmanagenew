...
import type { AntDesignComponent} from '../types/ast-types';
import { ReactComponentAnalysis } from '../types/ast-types';
      ...
      try {
        ...
        const enhancedComponent: EnhancedComponent = {
          ...
          documentation: {
            ...
            examples: [],
            props: figmaComponent.properties?.map((prop: any) => ({
              name: prop.name,
              type: prop.type,
            ...
            variants: figmaComponent.variants?.map((variant: any) => ({
              name: variant.name,
