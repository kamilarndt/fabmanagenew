...
export default function CalendarDesigners() {
    const {
        events,
        resources,
        createEvent,
    ...
    const designerEvents = useMemo(() => {
        return getEventsByResourceType('designer');
    }, [events, getEventsByResourceType]);

    const designerResources = useMemo(() => {
        return getResourcesByType('designer');
