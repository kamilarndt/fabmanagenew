...
import { Card, Row, Col, Input, Select, Button, Space, Typography, Tabs } from 'antd'
        ...
        <div className="container-fluid py-3">
            ...
            <Tabs activeKey={activeTab} onChange={setActiveTab}>
                ...
                <TabPane tab="Katalog" key="catalog">
                        ...
                        <Row gutter={16} align="middle">
                            ...
                            <Col xs={24} sm={4}>
                                ...
                                >
                                    ...
                                    <Select.Option value="Tworzywa sztuczne">Tworzywa sztuczne</Select.Option>
                            ...
                            <Col xs={24} sm={4}>
                                ...
                                >
                                    ...
                                    <Select.Option value="lastOrder">Ostatnie zlecenie</Select.Option>
                                </Select>
                            </Col>
                            <Col xs={24} sm={4}>
                                <Space>
                            ...
                            <Card size="small">
                                <div style={{ textAlign: 'center' }}>
                                    <Title level={3} style={{ margin: 0, color: '#52c41a' }}>
                                        {filteredSubcontractors.filter(s => s.status === 'Aktywny').length}
                                    </Title>
                                    <div>Aktywnych</div>
                                </div>
                            </Card>
                            ...
                            <Card size="small">
                                <div style={{ textAlign: 'center' }}>
                                    <Title level={3} style={{ margin: 0, color: '#faad14' }}>
                                        {filteredSubcontractors.reduce((sum, s) => sum + s.currentOrders.length, 0)}
                                    </Title>
                                ...
                                <div style={{ textAlign: 'center' }}>
                                    <Title level={3} style={{ margin: 0, color: '#722ed1' }}>
                                        {filteredSubcontractors.length > 0
                                            ? (filteredSubcontractors.reduce((sum, s) => sum + s.rating, 0) / filteredSubcontractors.length).toFixed(1)
                                            : '0.0'
                                        }
                                    </Title>
                    ...
                    {filteredSubcontractors.length === 0 && (
                        <Card style={{ textAlign: 'center', padding: 40 }}>
                            <Title level={4} type="secondary">Brak podwykonawców</Title>
                            <p>Nie znaleziono podwykonawców spełniających kryteria wyszukiwania.</p>
                            <Button type="primary" icon={<PlusOutlined />} onClick={() => setActiveTab('add')}>
                ...
                <TabPane tab="Profil" key="profile" disabled={!selectedSubcontractor}>
                    {selectedSubcontractor && (
                        <SubcontractorProfile subcontractor={selectedSubcontractor as any} />
                    )}
                </TabPane>
